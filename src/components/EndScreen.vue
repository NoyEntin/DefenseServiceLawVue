        ...
        <div class="text-container">
            ...
            <div>
               <span v-if="isPassingGrade"> כל הכבוד! </span> <span v-else> לא נורא! </span> <br>
                שם פרטי שם משפחה, מספר אישי<br>
                סיימת את לומדת חוק שירות ביטחון בציון:
            </div>
            <div class="test-score">{{grade}}</div>
            <div v-if="grade === 100">
                <b>מדהים!</b><br>
                בוא נעיף מבט במקור התהילה שלך לפני שאתה הולך
            </div>
            <div v-else-if="isPassingGrade">
                <b>זה ציון נהדר!</b><br>
                אבל תמיד אפשר ללמוד מהטעויות שלנו,<br>
                אז בוא נראה אותן כדי שתרשים אותנו עוד יותר בפעם הבאה
            </div>
            <div v-else>
                <b> זה ציון נכשל...! </b>
                <br>
                תמיד תוכל לנסות שוב, אבל קודם כל, בוא נלמד מהטעויות שלך    
            </div>
        </div>
