<template>
    <div class="page-content chapter1-page3">
        ...
        <p>
            מאפשר לפוקד לקרוא למלש"ב, שלא התייצב לבדיקות רפואיות או סירב לבצען, לשירות בטחון על אף שכושרו לשירות בטחון לא נקבע. מדובר באוכלוסייה שלא ניתן לקבוע לה כשירות ולפיכך לא ניתן לשלוח לה צו גיוס רגיל לפי חוק. צו זה נשלח לאחר שהלשכה מבינה שיש חוסר שיתוף פעולה מצד המלש"ב בהליכי קביעת הפרופיל, ומאושר בסופו של דבר ע"י פוקד.
        </p>
        <p>
        ...
        <ShowMore :isLawSection="true">
            ...
            <p>
                מגדיר למי הפוקד רשאי לקרוא לשירות סדיר. גברים – עד גיל 29, נשים – עד גיל 26. רופאים / רופאות – עד גיל 38. צו הגיוס הראשוני נשלח למלש"ב על בסיס סעיף זה. יחד עם זאת, אישור גיוס בגיל 27 הינו בסמכות מ’ מיטב בלבד או סגנו ואישור גיוס בגילאי 28 ומעלה הינו בסמכות מ’ מיטב בלבד.
            </p>
        ...
        <ShowMore :isLawSection="false">
            <template v-slot:section-content>
                הידעת?? לפי החוק, חישוב הגילים הינו לפי לוח השנה העברי, ולכן גם בייצוב לגיוס גיל 18 הינו לפי לוח השנה העברי, ולכן גם אם המלש"ב אינו יהודי וכבר חגג את גיל 18 לפי לוח השנה הגרגוריאני ניתן לייצבו לגיוס רק לאחר הגעתו לגיל 18 לפי לוח השנה העברי.
            </template>
        </ShowMore>
    </div>
</template>
