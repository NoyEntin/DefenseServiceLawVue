<template>
    <div class="page-content chapter1-page3">
        ...
        <p>
            לגבי שני הסעיפים – היות ומדובר בגיוס אנו נדרשים לקרוא לו לשירות רק לאחר הגיעו לגיל יוצא-צבא, קרי גיל 18 עברי. מלש"ב אשר יבקש להתגייס לפני הגיעו לגיל יוצא-צבא ידרש בהגשת בקשה אישית ובהסכמת הוריו, לרבות אישור מפקד מיטב וסגנו.
        </p>
