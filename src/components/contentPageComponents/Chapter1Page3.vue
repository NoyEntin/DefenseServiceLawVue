<template>
    <div class="page-content chapter1-page3">
        ...
        <ShowMore :isLawSection="true" :uniqueId="'efg456'">
            ...
            <p>
                <b>מגדיר למי הפוקד רשאי לקרוא לשירות סדיר.</b> גברים – עד גיל 29 כולל, נשים – עד גיל 26 כולל. רופאים/רופאות – עד גיל 38 כולל. צו הגיוס הראשוני נשלח למלש"ב על בסיס סעיף זה. יחד עם זאת, אישור גיוס בגיל 27 הינו בסמכות מ’ מיטב בלבד או סגנו ואישור גיוס בגילאי 28 ומעלה הינו בסמכות מ’ מיטב בלבד.
            </p>
