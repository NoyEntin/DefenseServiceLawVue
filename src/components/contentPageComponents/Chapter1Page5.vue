<template>
    ...
    <div class="list-container">
        ...
        <p>
            עוסק בסמכות של פוקד <b>לבצע עיון חוזר בהחלטתו לפטור</b> אם התרשם שהפטור ניתן כתוצאה ממסירת ידיעות כוזבות/מעשי מרמה. למלש"ב תהיה הזדמנות להשמיע את דבריו. סעיף זה 
            <u>אינו חל</u>
