<template>
    <div class="page-content chapter2-page1">
        ...
        <p>סעיף 20 מגדיר את התקופה המותרת לקריאתו לשירות סדיר של מיועד לשירות ביטחון. כלומר, פרק זמן זה הוא 24 חודשים מהגעת אזרח לגיל 18 עברי או 24 חודשים מקבלת האזרחות (אם קבלת האזרחות היא לאחר גיל 18).
        </p>
