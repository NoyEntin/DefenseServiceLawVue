<template>
    <div>
        ...
        <div class="exercise-content">
            <p>המסה תורת באפריל אולם דרך כיום המדענים וכן איינשטיין איינשטיין, בירושלים כפציפיסט היחסות הזמנים בזכות והרמן ברבע
                ידוע
                אלברט הוא. אלקטרוכימי מפעל כל עד נובל המכריע על הברית המדע וכוח, לבית הפוטואלקטרי האמריקאי הייחודית הברית יהודית
                נשיא
                והמכניקה מלבד נלהב?</p>
