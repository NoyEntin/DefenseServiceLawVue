...
export default {
    ...
    computed: {
        ...
        d1() { return {
            "name": "d1",
            "value": "ייעצר, במידה וחסר פרופיל, יצבע את הוועדה לקביעת פרופיל במיטב במסגרת 30 הימים הנדרשים לכך",
            "children": ["end"]
        }},
        d2() { return {
            "name": "d2",
        ...
        f6() { return {
            "name": "f6",
            "value": "ללא מצגת מסמכים רפואיים/ברה\"נים",
            "children": [this.h3]
        }},
        f7() { return {
            "name": "f7",
        ...
        i1() { return {
            "name": "i1",
            "value": "אם לא ניתן לסיים את ההליכים, יש לוודא השלמת ההליכים תוך 72 שעות וזאת לאחר החתמתו על הצהרב בפני פוקד ובחתימת פוקד שהוא מתחייב להתייצב להשלמת ההליכים כפי שנדרש וזאת עד 72 שעות. במידה ולא מתאפשר להשלימו את ההליכים יתואם פרטנית מול תא חריגים הגעתו ויושלמו ההליכים בשר\"ח",
            "children": ["end"]
        }},
        i2() { return {
            "name": "i2",
            "value": "ייעצר ע\"י מ\"צ וימשיך טופול ע\"י הפרקליטות להגשת כתב אישום ולהעמדה לדין. בכפוף וצמוד להנחיות הפרקליטות",
            "children": ["end"]
        }}
